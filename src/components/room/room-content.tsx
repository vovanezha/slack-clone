...
export const RoomContent = ({ header, messages, messagesLoading }: Props) => {
  return (
          ...
          {messagesLoading ? (
            ...
            <>
              {messages.length > 0 ? (
                ...
                <p className="mb-4 text-center font-medium text-gray-500">
                  There are no messages yet. Start chating...
                </p>
              )}
            </>
          )}
